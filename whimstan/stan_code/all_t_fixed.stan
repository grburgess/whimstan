...
model{
  ...
  target += reduce_sum(partial_log_like_all_t_fixed, all_N, grainsize, N_ene, N_chan, ene_avg, ene_width, mask, n_chans_used, mw_abs, K, index, n0_whim, whim_abs_base, nH_host, host_precomputed_absorp, rsp, exposure, exposure_ratio, counts, bkg);
